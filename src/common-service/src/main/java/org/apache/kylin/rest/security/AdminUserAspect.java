...
public class AdminUserAspect {
    ...
    @AfterReturning(value = "execution(* io.kyligence.kap.rest.service.OpenUserService.listAdminUsers(..))", returning = "adminUserList")
    public void doAfterListAdminUsers(List<String> adminUserList) {
        ...
        if (!Objects.equals(adminUserList, this.adminUserList)) {
