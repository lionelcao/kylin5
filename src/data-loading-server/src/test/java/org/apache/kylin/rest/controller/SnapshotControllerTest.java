...
public class SnapshotControllerTest extends NLocalFileMetadataTestCase {
    ...
    public void testGetSnapshots() throws Exception {
        ...
        Mockito.doAnswer(x -> Pair.newPair(null, 0)).when(snapshotService).getProjectSnapshots(project, table, statusFilter,
    ...
    public void testGetSnapshotsWithInvalidSortBy() throws Exception {
        ...
        boolean isReversed = true;
        Mockito.doAnswer(x -> Pair.newPair(null, 0)).when(snapshotService).getProjectSnapshots(project, table, statusFilter, null,
